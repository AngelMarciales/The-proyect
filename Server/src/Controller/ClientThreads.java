...
public class ClientThreads extends Thread implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // if
        // (functions.get(i).getFilm().getName().equalsIgnoreCase(views.dialogBuy.getTxtComboBox()))
        // {
        ...
        // for (int i = 0; i < films.size(); i++) {
        // if
        // (films.get(i).getName().equalsIgnoreCase(views.dialogBillBoard.getTxtComboBox()))
        // {
        ...
        // break;
        // case "Continuar":
        // views.setValue(String.valueOf(cinema.calculateDiscount(cost,
        // views.dialogBuy.getTxtClient())));
