        ...
        try {
            ...
            switch (source) {
                ...
                case "Aceptar3":
                    ...
                    break;
                case "Editar funcion":
                    output.writeUTF(new Gson().toJson("Editar funcion"));
                    views.setVisible(false);
                    views.editFunctionPanel.setVisible(true);
                    String[] editedLista = new Gson().fromJson(input.readUTF(), String[].class);
                    views.addEditedFilmItems(editedLista);
                    String[] editedRooms = new String[] { "1", "2", "3", "4", "5" };
                    views.addEditedRoomItems(editedRooms);
                    break;
                case "Aceptar4":
